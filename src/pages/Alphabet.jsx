        ...
        <>
            ...
            <div className="flex h-screen justify-between p-5">
                ...
                <div className="flex w-full flex-col items-center justify-center font-bubbles text-white mobile:space-y-3">
                    <div className="text-shadow relative flex h-[70%] w-[80%] justify-center rounded-3xl border-8 border-lava bg-white p-8 mobile:h-[80%] mobile:h-[85%] mobile:border-4 mobile:p-4 ipad:h-[60%] ipad:p-6">
                        ...
                        <div className="inner-shadow flex h-full w-full items-center justify-evenly space-x-4 rounded-2xl border-[0.5px] border-softgray bg-cheese p-4 mobile:overflow-x-auto mobile:rounded-xl ipad:overflow-x-auto">
                            <Link
                                to="/leveldifficulty"
                                className="text-shadow h-[80%] w-72 flex-shrink-0 rounded-2xl border-8 border-lava bg-butter mobile:h-[90%] mobile:w-1/3 mobile:border-4 ipad:w-60"
                            ></Link>
                            <Link
                                to="/leveldifficulty"
                                className="text-shadow h-[80%] w-72 flex-shrink-0 rounded-2xl border-8 border-lava bg-butter mobile:h-[90%] mobile:w-1/3 mobile:border-4 ipad:w-60"

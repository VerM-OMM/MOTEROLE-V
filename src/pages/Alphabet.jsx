        ...
        <>
            ...
            <div className="flex h-screen justify-between p-5">
                ...
                <div className="flex w-full flex-col items-center justify-center font-bubbles text-white mobile:space-y-3">
                    <div className="text-shadow relative flex h-[70%] w-[80%] justify-center rounded-3xl border-8 border-lava bg-white p-8 mobile:h-[80%] mobile:p-4 ipad:h-[60%] ipad:p-6">
                        <span className="absolute -top-9 flex h-14 w-1/3 items-center justify-center rounded-2xl border-8 border-lava bg-white font-nunito text-4xl font-black text-black mobile:h-12 mobile:text-2xl ipad:text-3xl">
                            Alphabeto
                        </span>
